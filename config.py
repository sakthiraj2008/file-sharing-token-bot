...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "8036b78d9b4f2ada3d00877dee7252cfaa359fb2")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 86400)) # Add time in seconds
IS_VERIFY = os.environ.get("IS_VERIFY", "True")
TUT_VID = os.environ.get("TUT_VID", "https://t.me/quick_download_linkzz/8") # shareus ka tut_vid he 

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002369890832"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1430742022 1430742022").split()):
        ADMINS.append(int(x))
except ValueError:
